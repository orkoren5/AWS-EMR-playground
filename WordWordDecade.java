...
public class WordWordDecade implements WritableComparable<WordWordDecade> {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((decade == "") ? 0 : decade.intValue());
		result = prime * result + ((word1 == "") ? 0 : word1.hashCode());
		result = prime * result + ((word2 == "") ? 0 : word2.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		if ((obj == null) || (obj.getClass() != this.getClass()))
			...
			return compareTo((WordPairKey)obj) == 0;
	}
